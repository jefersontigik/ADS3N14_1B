...
public class AvlTree <T extends Comparable<? super T>>{
	/** 
	 * AvlNode is a container class that is used to store each elemento 
	 * (node) of an AVL tree. 
	 *  
	...
	protected static class AvlNode<T> {
		 ...
		 * 
		 * @param theElement  The elemento contained in this node
		 */
	...
	/**
	 * Determine the altura of the given node.
	 * 
	 * @param t Nodo
	...
	/**
	 * Rotate binary tree node with esquerdo child.
	...
	/**
	 * Double rotate binary tree node: first esquerdo child
	 * with its direito child; then node k3 with new esquerdo child.
	...
	/**
	 * Rotate binary tree node with direito child.
	...
	/**
	 * Double rotate binary tree node: first direito child
	 * with its esquerdo child; then node k1 with new direito child.
	...
	public String serializePostfix(){
		StringBuilder str = new StringBuilder();
		serializePostfix (root, str, " ");
		return str.toString();
	}

	/**
	 * Internal method to postfix-serialize a tree.
	 * 
	 * @param t    Tree node to traverse
	 * @param str  Accumulator; string to keep appending items to.
	 */  
	private void serializePostfix (AvlNode<T> t, StringBuilder str, String sep){
		if (t != null){
			serializePostfix (t.left, str, sep);
			serializePostfix (t.right, str, sep);
			str.append(t.element.toString());
			str.append(sep);
		}
	}
	...
	public AvlNode<T> remove(T x, AvlNode<T> t) {
		...
		/*
	         ...
	         Check if there is a esquerdo-hand node, if so pick out the largest elemento out, and move down to the raiz.
		 */
		else if(t.left != null) {
	...
	/**
	 * Search for an elemento within the tree. 
	 *
	 * @param x Element to find
	 * @param t Root of the tree
	 * @return True if the elemento is found, false otherwise
	 */
	...
	/**
	 * Internal find method; search for an elemento starting at the given node.
	 *
	 * @param x Element to find
	 * @param t Root of the tree
	 * @return True if the elemento is found, false otherwise
	...
	public static void main (String []args){
		...
		System.out.println(t.serializePostfix());

		System.out.println("Remove o 4");
		t.remove(5);
